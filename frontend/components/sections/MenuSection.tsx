...
export default function MenuSection() {
  ...
  return (
    ...
    >
      ...
      <p className="text-gray-700 mb-12 sm:text-base text-sm">
      ...
      >
        {popularMenu.map((item) => (
          ...
          >
            ...
            <h3 className="font-bold sm:text-lg text-base text-start">
              {item.name}
            </h3>
            ...
            <div className="w-full py-2 flex items-center justify-between">
              ...
              <Link
                ...
                className="bg-orangeAccent text-white px-4 py-2 sm:text-base text-sm rounded-full block mt-2"
              >
                Pesan
              </Link>
            </div>
